	...
	const handleDelete = (commentNo) => {
		try {
			...
			setCommentData((prevData) =>
				prevData.filter((item) => item.no !== commentNo),
			);
			alert("삭제되었습니다!");
		} catch (error) {
			...
			{detailData ? (
				<>
					<div id="pageVisual">
						...
						<p className="info">
							<Link to={`/booklog/${detailData?.booklog_no?.user?.no}`}>
								<span className="writer">
									<b>by</b> {detailData?.booklog_no?.user?.nickname}
								</span>
							</Link>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<span className="count">조회수 : {detailData?.cnt}</span>
							...
							<div className="bookCard">
								...
								<div className="txtBox">
									...
									<ul className="info">
										<li className="">
											<b>저자</b>
											<span>{detailData?.books_no?.author}</span>
										</li>
										<li className="">
											<b>출판</b>
                ...
                <Link to={`/booklog/article/update/${no}`}>
                  <button className="updateContent">수정하기</button>
                </Link>
                )
              }
						</section>
												...
												<div className="commInner">
													...
													{isEditModalOpen && editCommentId === comm.no ? (
														...
														<>
															...
															<p className="content">{comm.content}</p>
