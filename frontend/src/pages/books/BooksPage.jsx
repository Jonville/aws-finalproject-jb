      ...
      <div id="pageContents">
        <section className="topSection">
          <div className="searchArea">
            <input type="text" name="search" id="bpsearch" className="searchBar" placeholder="찾고 싶은 도서를 검색해 주세요.&nbsp;&nbsp;예시) 비스킷, 어린왕자, 세계 문학" onKeyUp={e => e.key == "Enter" && queryStringChanger()} ref={bookQuery} />
