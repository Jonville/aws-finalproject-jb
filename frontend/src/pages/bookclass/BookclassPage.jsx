...
const BookClass = () => {
  ...
  // input control
  // const searchInputAdmin = useRef();
  // 왜 알아서 인풋이 초기화 되는지 모르겠음.
    ...
    return(
      <div className="listArea admin noDrag">
        <div className='admin_searchBox'>
          ...
          <button type="button" onClick={e => {setDataList(temporary);}} >검색 초기화</button>
        </div>
      ...
      <div id="pageContents">
        <section className="topSection">
          <div className="searchArea">
            <input type="text" name="search" id="bookclassSearch" className="searchBar" autoComplete="off" placeholder="찾고 싶은 북클래스를 검색해 주세요." onKeyDown={e => e.key == "Enter" && searchClass()} ref={searchInput}/>
