...
const MemberInfo = () => {
	const props = useContext(Context); // userInfo 데이터를 가져오기 위해 사용
  ...
  const [detailAddress, setDetailAddress] = useState(null);
	...
	const data = {
		...
		zipCode: postcode !== '' ? postcode: userInfo?.zipCode ,
		address: location !== '' ? location : userInfo?.address ,
		address_detail: locationDetail !== '' ? locationDetail : userInfo?.address_detail 
	}
