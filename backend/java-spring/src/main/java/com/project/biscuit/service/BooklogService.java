...
import com.project.biscuit.model.dto.BooklogResponse;
...
public class BooklogService {
    ...
    public Booklog getBooklogByUserNo(Long userNo) {
        Optional<Booklog> optionalBooklog = booklogRepository.findByUserNo(userNo);
