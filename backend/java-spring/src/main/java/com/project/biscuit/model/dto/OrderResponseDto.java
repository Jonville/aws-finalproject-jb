...
public class OrderResponseDto {
    ...
    public static OrderResponseDto ofWithGoods(Orders ord) {
        return OrderResponseDto.builder()
                .no(ord.getNo())
                .merchant_uid(ord.getMerchant_uid())
                .orderCnt(ord.getOrderCnt())
...
//                .gImgPath(ord.getGoods().getImagesList().stream().filter(img -> img.getThumbnailYn().equals("Y")).toList().get(0).getImgPath())
                .build();
    }
}
